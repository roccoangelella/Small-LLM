...
4. **No Word-Count Limits**: Do NOT impose artificial word-count limits (e.g. "under 220 words", "under 300 words") on worker prompts. Let the worker return complete and natural technical explanations.
5. **Context Protection**: The worker must return synthesized, high-signal results. Never dump raw document files into the parent conversation.
