...
- On `edo/moe-experiment-ready`, keep the frozen 100M/2B GDN-2 hybrid recipe for the paired MoE pilot (ADR 0157). Older dense/SFT lifecycle records are inherited context, not new launch instructions.
