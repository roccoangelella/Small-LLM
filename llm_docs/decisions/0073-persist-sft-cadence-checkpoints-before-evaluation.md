...
# ADR 0073 — Persist SFT cadence checkpoints before evaluation
...
1. Keep evaluation before checkpointing and accept that a cadence-side failure can erase healthy optimizer progress.
2. Save locally before evaluation but publish remotely afterward.
3. Persist locally and remotely before running qualification side effects.
