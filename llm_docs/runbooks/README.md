...
- [`20m_1b_runbook.md`](20m_1b_runbook.md) — authorized fresh 20M-model / 1B-token scaling run; VPS build, private Kaggle publication, exact-resume T4 training, and final evaluation.
