...
This runbook implements ADR 0112/0113 and the dataset-production refactor in ADR 0115. The frozen 16,716-row Stage-1-expanded reasoning corpus is the immutable base; Superior Reasoning Stage 2 `instruction_following` is additive scaling data for the nested 1% / 2% / 4% sweep.
