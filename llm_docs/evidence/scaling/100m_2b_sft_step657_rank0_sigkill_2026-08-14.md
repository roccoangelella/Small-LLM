...
ADR 0074 responds by disabling the qualification-only optimizer instrumentation for the Kaggle SFT child process, bounding glibc allocator arenas, and preserving the continuous exact-resume scientific protocol.
