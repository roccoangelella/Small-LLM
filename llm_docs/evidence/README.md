...
- [`scaling/100m_2b_sft_step657_rank0_sigkill_2026-08-14.md`](scaling/100m_2b_sft_step657_rank0_sigkill_2026-08-14.md) — finite continuous SFT training through step 657 followed by an external rank-zero kill and the bounded-host-memory response.
- [`scaling/100m_2b_sft_step250_checkpoint_host_kill_2026-08-14.md`](scaling/100m_2b_sft_step250_checkpoint_host_kill_2026-08-14.md) — checkpoint-first SFT reached step 250, then rank zero was killed during the full-tree host-memory checkpoint path.
