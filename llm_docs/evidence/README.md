...
Evidence records completed observations: measured results, verification reports, accepted checkpoint selection, and qualitative outputs. Preserve these files unchanged except for explicit factual corrections.
