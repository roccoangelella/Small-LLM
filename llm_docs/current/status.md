...
- ADR 0160 supersedes ADR 0159 (and transitively ADR 0153) and selects approximately 200M parameters trained on the full 100B target-token corpus as the next major pretraining trajectory. Architecture, LR/scheduler, update geometry, checkpoint cadence, and provider execution details remain open until explicitly frozen.
