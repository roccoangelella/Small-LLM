...
# pinned to the exact step-64 warmup / peak-through-3000 implementation plus
# the rank-zero-only remote cadence fix that prevents the secondary DDP rank
# from racing Hugging Face cleanup against the primary publisher.
TEN_PERCENT_TRAIN_COMMIT = "9671749bbdced230ebe9bf734d00af791ba92d75"
