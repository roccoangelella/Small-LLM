...
It preserves the post-SFT eval-core, instruction-behavior, greedy-32 and standard
sampled-native regressions, then adds held-out R-SFT loss, novel mechanically scored
