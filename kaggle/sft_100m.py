...
IMPLEMENTATION_COMMIT = "bf7631a36c052ee1b5d00c4a641705f60d251724"
...
PROFILE = Profile(
    ...
    sft_run_id="100m-2b-sft-s0-10pct-001",
    wandb_run_id="100m-2b-sft-s0-10pct-001",
    wandb_run_name="100M / 2B parent / SFT S0 / 10%",
    dataset_slug="small-llm-100m-2b-sft-s0-10pct-001",
    known_parent_consumed_tokens=2_001_000_448,
    launch_commit=IMPLEMENTATION_COMMIT,
    sft_fraction_numerator=10,
