...
class TrainerEngine:
    ...
    def __init__(self, model: nn.Module, config: TrainerConfig, *,
        ...
        self.optimizer = optimizer if optimizer is not None else build_adamw(self.model, config)
    ...
    def evaluate(self, batches: Iterable[TokenBatch], *,
...
__all__ = ["StepMetrics", "TrainerEngine", "TrainingSession", "build_adamw",
           "generate_token_ids", "seed_everything"]
