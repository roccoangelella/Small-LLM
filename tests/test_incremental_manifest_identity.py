...
def test_producer_completion_does_not_change_trainer_manifest() -> None:
    contract = {
        "version": 1,
        "run_id": "dataset-001",
    ...
    assert _stable_consumer_manifest(contract, active) == _stable_consumer_manifest(contract, complete)
